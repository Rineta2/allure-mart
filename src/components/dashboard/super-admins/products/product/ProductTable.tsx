...
import { ProductTableProps } from "@/components/dashboard/super-admins/products/product/schema/schema";
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-gray-900">
                                                    {product.author?.displayName || 'Unknown Author'}
                                                </p>
                                                <p className="text-xs text-gray-500">
                                                    {product.author?.role || 'No Role'}
                                                </p>
                                            </div>
                                        </div>
                                    </td>
