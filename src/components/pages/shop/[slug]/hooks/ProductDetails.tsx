    ...
    return (
        <div className="flex items-center gap-3 sm:gap-4 flex-col sm:flex-row">
            <div className="flex items-center border-2 border-gray-200 rounded-xl w-full sm:w-auto overflow-hidden">
                <button className="px-4 md:px-5 py-3 text-gray-600 bg-transparent hover:bg-gray-50 transition-colors font-medium text-lg">
                    -
                </button>
                <input
                    type="number"
                ...
                />
                <button className="px-4 md:px-5 py-3 text-gray-600 hover:bg-gray-50 transition-colors font-medium text-lg">
                    +
                </button>
            </div>
